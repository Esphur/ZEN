...
init()
{
	...
	setDvarIfUninitialized( "bots_manage_add", 1 );			  // amount of bots to add to the game
	...
	setDvarIfUninitialized( "bots_skill", 1 );			 // 0 is random, 1 is easy 7 is hard, 8 is custom, 9 is completely random
	...
	setDvarIfUninitialized( "bots_loadout_prestige", 9 );
